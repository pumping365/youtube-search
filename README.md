...
- 🎯 **9가지 원클릭 카테고리**: 정치, 경제, 부동산, 드론, PET, 사회, IT 기술, 트렌드, 사건사고
- 🌍 **11개국 선택**: 한국, 미국, 일본, 중국, 영국, 프랑스, 독일, 태국, 베트남, 싱가포르, 호주
- 📅 **검색 기간 설정**: 날짜 범위 선택 또는 최근 7/30/60/90일 버튼
- 🔍 **고급 검색 옵션**: 최소 조회수/구독자, 정렬 방식, 최대 결과 수
...
| 지표 | 점수 | 설명 |
|------|------|------|
| 🎯 **구독자 점수** | 30/30점 | 채널 규모 평가 |
| 📊 **조회수 점수** | 30/30점 | 콘텐츠 인기도 |
| 💬 **참여율 점수** | 20/20점 | 좋아요/댓글 비율 |
| 📅 **일관성 점수** | 20/20점 | 업로드 주기 |
| 📈 **종합 평가** | S등급 | 100/100점 |

**4종 차트 시각화:**
- 🍩 **도넛 차트**: 종합 점수 (구독자/조회수/참여/일관성)
- 🕸️ **레이더 차트**: 5개 지표 비교
- 📊 **바 차트**: 구독자 성장 추세
- 🎯 **게이지 차트**: 참여율 실시간 표시
